                            ...
                            <div class="demo-box m-t-20">
                                ...
                                <div class="table-responsive">
                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                        ...
                                        <tbody>
<?php 
$query=mysqli_query($con,"SELECT malichhoc, macongno, malop, makhoilop, mahocsinh, hoten, gioitinh, trangthai, ngayvaotruong, diachi, sdt, khoahoc, ngaysinh, socmnd, dantoc, tongiao, noisinh, lop, hinh, khoi, email, active FROM hocsinh WHERE active=1");
$cnt=1;
...
?>
                                            ...
                                            &nbsp;<a href="manage-student.php?rid=<?php echo htmlentities($row['id']);?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
                                            </tr>
                                        <?php
                                        $cnt++;
                                        } ?>
...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlentities($row['gioitinh']);?></td>
                                        <td><?php echo htmlentities($row['lop']);?></td>
                                        <td><a href="manage-student.php?resid=<?php echo htmlentities($row['id']);?>"><i class="ion-arrow-return-right" title="Khôi phục"></i></a> 
                                        &nbsp;<a href="manage-student.php?rid=<?php echo htmlentities($row['id']);?>&&action=parmdel" title="Xoá vĩnh viễn"> <i class="fa fa-trash-o" style="color: #f05050"></i> </td>
                                    </tr>
                                <?php
                                $cnt++;
                                } ?>
